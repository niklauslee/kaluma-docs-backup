...
Finishes to write HTTP headers and body. Actually the request will be sent to the server and you will be received the response via [`'response'`](http.md#event-response) event.
